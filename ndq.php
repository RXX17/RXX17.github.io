...
var z = document.forms["myForm"]["ans1"].value;
    if (z == null || z == "") {
        alert("At least one answer must be given");
        return false;
    }
...
<form name="Form" action="ndq1.php" onsubmit="return validateForm()" method="post">
<center><div class="ana"><br><br>
Your Name: <input type="text" name="name" size=40><br><br>
Quiz Name: <input type="text" name="ques" size=40><br><br>
Answer1:<input type="text" name="ans1"><br>
Answer2:<input type="text" name="ans2"><br>
Answer3:<input type="text" name="ans3"><br>
Answer4:<input type="text" name="ans4"><br>
Answer5:<input type="text" name="ans5"><br>
Answer6:<input type="text" name="ans6"><br><br>
