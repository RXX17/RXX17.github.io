...
if($r==1)
{
echo "<h1> Snow White</h1>";
echo "<img src='Q11.jpg' height=600 width=800>";
echo "<br>";

echo "<font size=+2>You are very innocent and friendly. Your innocence can change the mind of the most cruel person. Even in so many difficulties, your smile is never gone. </font>";
}

if($r==2)
{ 
echo "<h1> Aurora</h1>";
 echo "<img src='Q12.jpg' height=600 width=800>";
echo "<br>";

echo "<font size=+2>You are romantic and sophisticated. You are beloved by everyone meets you. </font>";
}

if($r==3)
{
 echo "<h1> Cinderella</h1>";
echo "<img src='Q13.jpg' height=600 width=800>";
echo "<br>";

echo "<font size=+2>Leader of the princesses! You are the example of how someone can change her fate. Though there is no fairy godmother in real world, but hard work can take her place. </font>";
}

if ($r==4)
{
 echo "<h1> Belle </h1>";
echo "<img src='Q14.jpg' height=600 width=800>";
echo "<br>";

echo "<font size=+2> Intelligent! You can even turn a beast into prince charming.</font>";
}

if($r==5)
{ 
 echo "<h1> Ariel </h1>";
echo "<img src='Q15.png' height=600 width=800>";
echo "<br>";
...
echo "<font size=+2> Magic! You are surrounded by aristocracy.</font>";
}
?>
</center>
...
$sql="INSERT INTO Persons (fname, fresult, fcomment)
VALUES
